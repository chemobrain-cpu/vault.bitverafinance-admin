...
const AdminCopyTrade = React.lazy(() => import('./screen/admin_screen/Dashboard/AdminCopyTrade'))


const AdminCopyTradeForm = React.lazy(() => import('./screen/admin_screen/Dashboard/AdminCopyTradeForm'))


const AdminCopyTradeFormEdit = React.lazy(() => import('./screen/admin_screen/Dashboard/AdminCopyTradeFormEdit'))
    ...
    <div className="App">
      <Suspense fallback={<FallBackComponent />}>
        <Routes>
          ...
          <Route path='/admindashboard/copy-trade' element={adminToken ? <AdminCopyTrade status={true} /> : <AdminLogin />} />

          <Route path='/admindashboard/add-copy-trade' element={adminToken ? <AdminCopyTradeForm status={true} /> : <AdminLogin />} />


          <Route path='/admindashboard/edit-copy-trade/:id' element={adminToken ? <AdminCopyTradeFormEdit status={true} /> : <AdminLogin />} />
